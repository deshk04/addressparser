...
raw_gnaf_202105.ADDRESS_DETAIL AD
LEFT JOIN raw_gnaf_202105.FLAT_TYPE_AUT FTA ON AD.FLAT_TYPE_CODE=FTA.CODE
LEFT JOIN raw_gnaf_202105.LEVEL_TYPE_AUT LTA ON AD.LEVEL_TYPE_CODE=LTA.CODE
JOIN raw_gnaf_202105.STREET_LOCALITY SL ON AD.STREET_LOCALITY_PID=SL.STREET_LOCALITY_PID
LEFT JOIN raw_gnaf_202105.STREET_SUFFIX_AUT SSA ON SL.STREET_SUFFIX_CODE=SSA.CODE
LEFT JOIN raw_gnaf_202105.STREET_CLASS_AUT SCA ON SL.STREET_CLASS_CODE=SCA.CODE
LEFT JOIN raw_gnaf_202105.STREET_TYPE_AUT STA ON SL.STREET_TYPE_CODE=STA.CODE
JOIN raw_gnaf_202105.LOCALITY L ON AD.LOCALITY_PID = L.LOCALITY_PID
JOIN raw_gnaf_202105.ADDRESS_DEFAULT_GEOCODE ADG ON AD.ADDRESS_DETAIL_PID=ADG.ADDRESS_DETAIL_PID
LEFT JOIN raw_gnaf_202105.GEOCODE_TYPE_AUT GTA ON ADG.GEOCODE_TYPE_CODE=GTA.CODE
LEFT JOIN raw_gnaf_202105.GEOCODED_LEVEL_TYPE_AUT GLTA ON AD.LEVEL_GEOCODED_CODE=GLTA.CODE
JOIN raw_gnaf_202105.STATE ST ON L.STATE_PID=ST.STATE_PID
