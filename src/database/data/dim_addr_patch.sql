...
--
-- Name: dim_addr_patch; Type: TABLE; Schema: public; Owner: addruser
--

CREATE TABLE public.dim_addr_patch (
...
ALTER TABLE public.dim_addr_patch OWNER TO addruser;

--
-- Data for Name: dim_addr_patch; Type: TABLE DATA; Schema: public; Owner: addruser
--

COPY public.dim_addr_patch (sourcestring, destinationstring, type) FROM stdin;
